<template>
  <div>
    <zqq-box ref="prov" :operation="boxOperation[0]" :title="boxTitle[0]" :operateId="0" :district-list="provinceList" :filterable="filterable" :filter-placeholder="filterPlaceholder" @check-district="checkProvince" @selected-checked="selectedProvince"></zqq-box>
    <zqq-box ref="city" :operation="boxOperation[1]" :title="boxTitle[1]" :operateId="1" :district-list="cityList" :filterable="filterable" :filter-placeholder="filterPlaceholder" @check-district="checkCity" @selected-checked="selectedCity"></zqq-box>
    <zqq-box ref="county" :operation="boxOperation[2]" :title="boxTitle[2]" :operateId="2" :district-list="countyList" :filterable="filterable" :filter-placeholder="filterPlaceholder" @selected-checked="selectedCountry"></zqq-box>
    <span class="inner-center el-icon-d-arrow-right"></span>
    <zqq-box style="width: 260px" :operation="boxOperation[3]" :title="boxTitle[3]" :district-list="checkedDistrict" :filterable="filterable" :filter-placeholder="filterPlaceholder" @delete-checked="deleteCheck"></zqq-box>
  </div>
</template>
